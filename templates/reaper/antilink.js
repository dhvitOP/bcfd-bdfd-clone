...
module.exports = {
  ...
  execute: async(client, message, args) => {
    ...
    {
       let antilink1 = db.fetch(`antilink_${message.guild.id}_${client.user.id}`);
      if(antilink1 == "on")
      {
      ...
      let on1 = "on";
      db.set(`antilink_${message.guild.id}_${client.user.id}`, on1);
     ...
     else if (content.toLowerCase() === "off") 
    {
      ...
      let off1 = "off";
      db.set(`antilink_${message.guild.id}_${client.user.id}`, off1);
